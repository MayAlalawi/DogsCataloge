...
brittany_dog = DogsItem(user_id=1, name="Brittany",
                        ...
                        "cherish the agile, energetic Brittany as a stylish and versatile" +
                        "gundog. Bright and eager at home, and tireless afield, Brittanys"+
                        " require a lot of exercises, preferably with their favorite humans.",
                        dogs=group1)
...
# English Setter Dog
english_setter = DogsItem(user_id=1, name="English Setter",
                        group="Sporting Group",
                        height="25-27 inches",
                        weight="65-80 pounds",
...
# Basenji Dog
basenji_dog = DogsItem(user_id=1, name="Basenji",
                        group="Hound Group",
                        height="17 inches",
                        weight="24 pounds",
...
# Beagle Dog
beagle_dog = DogsItem(user_id=1, name="Beagle Dog",
                        group="Hound Group",
                        height="13 inches",
                        weight="under 20 pounds",
                        temperament="Friendly, Curious, Merry",
                        description="Not only is the Beagle an excellent hunting dog and loyal " +
                        "companion, it is also happy-go-lucky, funny, and cute." +
                        "They were bred to hunt in packs, so they enjoy company and "+
...
# Boerboel Dog
boerboel_dog = DogsItem(user_id=1, name="Boerboel",
                        group="Working Group",
                        height="24-27 inches",
                        weight="150-200  pounds",
                        temperament="Confident, Intelligent, Calm",
                        description="Boerboels are intimidating but discerning guardians of " +
                        "home and family who learned their trade while protecting remote South African " +
                        "homesteads from ferocious predators. They are dominant and confident,"+
                        " also bright and eager to learn.",
                        dogs=group3)
...
# Akita Dog
akita_dog = DogsItem(user_id=1, name="Akita Dog",
                        group="Working Group",
                        height="26-28 inches",
                        weight="100-130  pounds",
                        temperament="Courageous, Dignified, Profoundly Loyal ",
                        description="Akita is muscular, double-coated dogs of ancient Japanese lineage " +
                        "famous for her dignity, courage, and loyalty. In her native land, " +
                        "she's venerated as family protectors and symbols of good health, "+
...
# Australian Terrier
australian_terrier = DogsItem(user_id=1, name="Australian Terrier",
                        group="Terrier Group",
                        height="10-11 inches",
                        weight="15-20 pounds",
...
# Bull Terrier
bull_terrier = DogsItem(user_id=1, name="Bull Terrier",
                        group="Terrier Group",
                        height="21-22 inches",
                        weight="50-70  pounds",
                        temperament="Playful, Charming, Mischievous",
                        description="Among the most comical and mischievous citizens of dogdom, the" +
                        "Bull Terrier is playful and endearing, sometimes stubborn, but always devoted." +
                        "These unique eggheads are exuberant, muscular companions who thrive on "+
                        "affection and exercise.",
                        dogs=group4)
